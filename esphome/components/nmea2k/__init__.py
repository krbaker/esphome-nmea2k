    ...
    cv.Schema(
        {
            ...
            cv.Required(CONF_NMEA2K_DEVICE_FUNCTION, default=5000): cv.int_,
            cv.Required(CONF_NMEA2K_DEVICE_CLASS, default=5000): cv.int_,
            cv.Required(CONF_NMEA2K_DEVICE_ID, default=5000): cv.int_,
            cv.Required(CONF_NMEA2K_PRODUCT_NAME, default="Unknown"): cv.str_,
            cv.Required(CONF_NMEA2K_PRODUCT_LOAD, default=1): cv.int_,
